...
#if (defined(__M8510__)||defined(__M8522__)||defined(__M8515__) || defined(__M8525__) || defined(__M8526__) || defined(__M8512__))|| defined(__M8513__)
//使用挂钩电池(不接充电器)可以开机
...
#ifdef __M8520__		//仅供用调试用
    printk("WARN!! (%d) CONV Norm temp!!\n", sBaTTMP);
    sBaTTMP = 32;    //20;
#endif
