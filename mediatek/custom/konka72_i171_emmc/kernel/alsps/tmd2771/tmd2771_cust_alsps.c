...
//    .als_value  = {10, 50,  100,  150, 200, 250,  280,  280, 1600,  1600,  1600,  6000,  6000, 9000,  10240, 10240},
    ...
    .als_level  = { 1,2,42,261,399,400,500,600,700,800,900,1000,1100,10000,65535},
    .als_value  = {10,28,40,80,120,150,200,250,400,800,1500,2500,3500,6000,9000},
    .ps_threshold_high = 900,
    .ps_threshold_low = 750,
    .ps_threshold = 700, //Rep 700 by cheehwa,
};
struct alsps_hw *TMD2771_get_cust_alsps_hw(void) {
    return &cust_alsps_hw;
}
int TMD2771_CMM_PPCOUNT_VALUE = 0x04; //0x02	//radio power
int ZOOM_TIME = 4;
