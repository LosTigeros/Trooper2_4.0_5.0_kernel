...
static void SP0A28_Sensor_Driver_Init(void)
{
	...
	SP0A28_write_cmos_sensor(0x58,0x06);
	SP0A28_write_cmos_sensor(0x56,0x0A);
	SP0A28_write_cmos_sensor(0x59,0x16);
	...
	SP0A28_write_cmos_sensor(0xec,0x20);
	SP0A28_write_cmos_sensor(0xe9,0x1C);
	SP0A28_write_cmos_sensor(0xed,0x20);
	SP0A28_write_cmos_sensor(0xea,0x1C);
	SP0A28_write_cmos_sensor(0xef,0x18);
	SP0A28_write_cmos_sensor(0xeb,0x08);
	SP0A28_write_cmos_sensor(0xf0,0x10);
	SP0A28_write_cmos_sensor(0xfd,0x01);
	...
	SP0A28_write_cmos_sensor(0xdd,0x80);
	SP0A28_write_cmos_sensor(0xde,0xa0);
