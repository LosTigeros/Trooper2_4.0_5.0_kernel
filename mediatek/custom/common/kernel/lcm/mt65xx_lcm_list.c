...
extern LCM_DRIVER otm8018b_wvga_dsi_vdo_lcm_drv;	
...
extern LCM_DRIVER rm68140_mcu_6572_lcm_drv;

extern LCM_DRIVER ili9448_mcu_6572_lcm_drv;
...
#if defined(OTM8018B_WVGA_DSI_VDO)	
	&otm8018b_wvga_dsi_vdo_lcm_drv, 
#endif
...
#if defined(RM68140_MCU_6572)
    &rm68140_mcu_6572_lcm_drv,
#endif

#if defined(ILI9448_MCU_6572)
    &ili9448_mcu_6572_lcm_drv,
#endif
