...
#if  defined(__M8525__)     //overseas - 充电温度检测范围统一设置为-20--55度 
    #define MAX_CHARGE_TEMPERATURE  55
    #define MIN_CHARGE_TEMPERATURE  -20
#elif (defined(__M8510__)||defined(__M8522__))
...
#elif defined(__M8510__)

    #define USB_CHARGER_CURRENT					CHARGE_CURRENT_500_00_MA	//500mA
    
    #if defined(__M8510_W991__)
        #define AC_CHARGER_CURRENT					CHARGE_CURRENT_800_00_MA   //V990-600mA,W991-800mA
    #else
        #define AC_CHARGER_CURRENT					CHARGE_CURRENT_600_00_MA
    #endif
#else
