...
static struct alsps_hw_stk3x1x cust_alsps_hw_stk3x1x = {
    ...
    .als_level  = {3,  15, 30, 64, 80, 96, 180, 250, 500, 845, 1136, 1545, 2364, 4655, 6982},	/* als_code */
    .als_value  = {10, 28,40, 80, 120,150, 200, 250, 400, 800, 1500, 2500, 3500, 6000, 9000, 10240},    /* lux */
...
struct alsps_hw_stk3x1x *get_cust_alsps_hw_stk3x1x(void) {
    return &cust_alsps_hw_stk3x1x;
}
