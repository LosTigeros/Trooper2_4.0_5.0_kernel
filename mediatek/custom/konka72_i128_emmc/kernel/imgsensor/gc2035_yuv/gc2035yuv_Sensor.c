...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x19 , 0x96);
	GC2035_write_cmos_sensor(0x1f , 0xb0);//max_post_gain  c0
	...
	GC2035_write_cmos_sensor(0x61, 0x20);  //21       pheobe
	...
	GC2035_write_cmos_sensor(0x81, 0x24);  
	GC2035_write_cmos_sensor(0x87 , 0xb0); //[7]middle gamma   90
	...
	//////////lsc////////////////////////
      GC2035_write_cmos_sensor(0xfe, 0x01);
      GC2035_write_cmos_sensor(0xc2, 0x3a);
      GC2035_write_cmos_sensor(0xc3, 0x2e);
      GC2035_write_cmos_sensor(0xc4, 0x24);
      GC2035_write_cmos_sensor(0xc8, 0x41);
      GC2035_write_cmos_sensor(0xc9, 0x38);
      GC2035_write_cmos_sensor(0xca, 0x2f);
      GC2035_write_cmos_sensor(0xbc, 0x60);
      GC2035_write_cmos_sensor(0xbd, 0x4d);
      GC2035_write_cmos_sensor(0xbe, 0x2d);
      GC2035_write_cmos_sensor(0xb6, 0x7f);
      GC2035_write_cmos_sensor(0xb7, 0x57);
      GC2035_write_cmos_sensor(0xb8, 0x61);
      GC2035_write_cmos_sensor(0xc5, 0x11);
      GC2035_write_cmos_sensor(0xc6, 0x09);
      GC2035_write_cmos_sensor(0xc7, 0x05);
      GC2035_write_cmos_sensor(0xcb, 0x12);
      GC2035_write_cmos_sensor(0xcc, 0x1e);
      GC2035_write_cmos_sensor(0xcd, 0x1b);
      GC2035_write_cmos_sensor(0xbf, 0x31);
      GC2035_write_cmos_sensor(0xc0, 0x28);
      GC2035_write_cmos_sensor(0xc1, 0x39);
      GC2035_write_cmos_sensor(0xb9, 0x0a);
      GC2035_write_cmos_sensor(0xba, 0x00);
      GC2035_write_cmos_sensor(0xbb, 0x1d);
      GC2035_write_cmos_sensor(0xaa, 0x00);
      GC2035_write_cmos_sensor(0xab, 0x08);
      GC2035_write_cmos_sensor(0xac, 0x10);
      GC2035_write_cmos_sensor(0xad, 0x10);
      GC2035_write_cmos_sensor(0xae, 0x11);
      GC2035_write_cmos_sensor(0xaf, 0x15);
      GC2035_write_cmos_sensor(0xb0, 0x14);
      GC2035_write_cmos_sensor(0xb1, 0x19);
      GC2035_write_cmos_sensor(0xb2, 0x1b);
      GC2035_write_cmos_sensor(0xb3, 0x06);
      GC2035_write_cmos_sensor(0xb4, 0x11);
      GC2035_write_cmos_sensor(0xb5, 0x01);
      GC2035_write_cmos_sensor(0xd0, 0x34);
      GC2035_write_cmos_sensor(0xd2, 0x2a);
      GC2035_write_cmos_sensor(0xd3, 0x36);
      GC2035_write_cmos_sensor(0xd8, 0x62);
      GC2035_write_cmos_sensor(0xda, 0x55);
      GC2035_write_cmos_sensor(0xdb, 0x5d);
      GC2035_write_cmos_sensor(0xdc, 0x88);
      GC2035_write_cmos_sensor(0xde, 0x7d);
      GC2035_write_cmos_sensor(0xdf, 0x8a);
      GC2035_write_cmos_sensor(0xd4, 0x01);
      GC2035_write_cmos_sensor(0xd6, 0x28);
      GC2035_write_cmos_sensor(0xd7, 0x05);
      GC2035_write_cmos_sensor(0xa4, 0x77);
      GC2035_write_cmos_sensor(0xa5, 0x73);
      GC2035_write_cmos_sensor(0xa6, 0x30);
      GC2035_write_cmos_sensor(0xa7, 0x77);
      GC2035_write_cmos_sensor(0xa8, 0x04);
	...
	GC2035_write_cmos_sensor(0xc1, 0x3d);  //cc for d        40
	GC2035_write_cmos_sensor(0xc2, 0xff);  //  fc
	GC2035_write_cmos_sensor(0xc3, 0x03); //05 
	GC2035_write_cmos_sensor(0xc4, 0xec);  
	GC2035_write_cmos_sensor(0xc5, 0x42);  //42
	...
	/////// awb value////////
       GC2035_write_cmos_sensor(0xfe, 0x01);        
       GC2035_write_cmos_sensor(0x4f, 0x00);        
       GC2035_write_cmos_sensor(0x4d, 0x23);  
	 GC2035_write_cmos_sensor(0x4e, 0x04); //d50
	 GC2035_write_cmos_sensor(0x4e, 0x04); //d50
       GC2035_write_cmos_sensor(0x4e, 0x00);  //d65 
       GC2035_write_cmos_sensor(0x4d, 0x32);        
       GC2035_write_cmos_sensor(0x4e, 0x08);   //cwf
       GC2035_write_cmos_sensor(0x4e, 0x08);  //cwf 
       GC2035_write_cmos_sensor(0x4e, 0x04);  // d50      
       ...
       GC2035_write_cmos_sensor(0x4e, 0x00);        
       GC2035_write_cmos_sensor(0x4e, 0x10);  // TL84
       GC2035_write_cmos_sensor(0x4e, 0x00);        
       GC2035_write_cmos_sensor(0x4e, 0x00);        
       GC2035_write_cmos_sensor(0x4d, 0x52);        
       GC2035_write_cmos_sensor(0x4e, 0x20); //A    
       GC2035_write_cmos_sensor(0x4e, 0x20);//A     
       GC2035_write_cmos_sensor(0x4d, 0x61);        
	...
	/////awb////             
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x50 , 0x8c);//c0//[6]green mode  88
	GC2035_write_cmos_sensor(0x52 , 0x40);
	GC2035_write_cmos_sensor(0x54 , 0x60);
	GC2035_write_cmos_sensor(0x56 , 0x0e);//06
	...
	GC2035_write_cmos_sensor(0x72 , 0x1d);//18
	...
	GC2035_write_cmos_sensor(0x80 , 0x20); //add 0x12
	GC2035_write_cmos_sensor(0x86 , 0x30);
	GC2035_write_cmos_sensor(0x87 , 0x00);
	GC2035_write_cmos_sensor(0x88 , 0x06);//06 , 0x//[1]dark mode  04
	...
	GC2035_write_cmos_sensor(0x8d , 0x70); //awb gain limit R   70
	...
	GC2035_write_cmos_sensor(0xa7 , 0x70); //ot_th
	
	GC2035_write_cmos_sensor(0xab , 0x31); //
	GC2035_write_cmos_sensor(0xa9 , 0x6f); //
	GC2035_write_cmos_sensor(0xb0 , 0x88); //0x//edge effect slope low
	
	GC2035_write_cmos_sensor(0xb1 , 0x00);//edge effect slope low  34
	...
	GC2035_write_cmos_sensor(0xd1, 0x3a); //38   40
	GC2035_write_cmos_sensor(0xd2, 0x3d);//38   40
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast ?
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center //pheobe
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x17);//dn_b_base  15
	GC2035_write_cmos_sensor(0x8c , 0xf6); //[2]b_in_dark_inc
	GC2035_write_cmos_sensor(0x89 , 0x03); //dn_c_weight  03
	////////EE ///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1
	GC2035_write_cmos_sensor(0x97 , 0x65);// edge effect
...
BOOL GC2035_set_param_wb(UINT16 para)
{
	switch (para)
	{
		...
		case AWB_MODE_INCANDESCENT: //office
			GC2035_set_AWB_mode(KAL_FALSE);
			GC2035_write_cmos_sensor(0xb3, 0x40);
			GC2035_write_cmos_sensor(0xb4, 0x4a);
			GC2035_write_cmos_sensor(0xb5, 0xa0);
		break;
		...
		case AWB_MODE_FLUORESCENT:
			GC2035_set_AWB_mode(KAL_FALSE);
			GC2035_write_cmos_sensor(0xb3, 0x4A);
			GC2035_write_cmos_sensor(0xb4, 0x60);
			GC2035_write_cmos_sensor(0xb5, 0xA0);
		break;	
		default:
		return FALSE;
...
#define FLASH_BV_THRESHOLD 0x40               //0x25
static void GC2035_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
	unsigned int NormBr;	   
	GC2035_SET_PAGE1;
	NormBr = GC2035_read_cmos_sensor(0x14); 
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
        ...
        case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
            GC2035_FlashTriggerCheck(pFeatureData32);
        break;		
