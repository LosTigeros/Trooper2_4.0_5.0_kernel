...
static void BF3905MIPI_HVMirror(ACDK_SENSOR_IMAGE_MIRROR_ENUM );
/*************************************************************************
* FUNCTION
...
static void BF3905MIPI_Sensor_Driver_Init(void)
{
	...
	BF3905_MIPI_write_cmos_sensor(0x70,0x0b);
	BF3905_MIPI_write_cmos_sensor(0x73,0x36);//0x27
	BF3905_MIPI_write_cmos_sensor(0x79,0x24);
	BF3905_MIPI_write_cmos_sensor(0x7a,0x24); //0x23 //2014.1.22 ycm//0x34
	...
	BF3905_MIPI_write_cmos_sensor(0x84,0x39);
	BF3905_MIPI_write_cmos_sensor(0x85,0x5d);
	BF3905_MIPI_write_cmos_sensor(0x86,0xa0); ///0x88// 0xc0
	BF3905_MIPI_write_cmos_sensor(0x89,0x7d); ///0x63   20131128 Fix AE unstable//0x75
	...
	//COLOR NEW nice skin by demo debug on 0111 zzg
	BF3905_MIPI_write_cmos_sensor(0x5a, 0xd6);
	BF3905_MIPI_write_cmos_sensor(0x51, 0x29);
	BF3905_MIPI_write_cmos_sensor(0x52, 0x1B);
	BF3905_MIPI_write_cmos_sensor(0x53, 0x91);
	BF3905_MIPI_write_cmos_sensor(0x54, 0x69);
	BF3905_MIPI_write_cmos_sensor(0x57, 0x56);
	BF3905_MIPI_write_cmos_sensor(0x58, 0x02);	
	*/
       #endif	
	...
	BF3905_MIPI_write_cmos_sensor(0xa3,0x20);//0x25
	...
	BF3905_MIPI_write_cmos_sensor(0xa7,0x1d);//0x17
	BF3905_MIPI_write_cmos_sensor(0xa8,0x10);//0x1a
	BF3905_MIPI_write_cmos_sensor(0xa9,0x20);//20  zj20140109 13
	BF3905_MIPI_write_cmos_sensor(0xaa,0x20);//20  zj20140109 18
	BF3905_MIPI_write_cmos_sensor(0xab,0x20);//20  zj20140109 1c
	BF3905_MIPI_write_cmos_sensor(0xac,0x3c);
	BF3905_MIPI_write_cmos_sensor(0xad,0xf0);
	...
	BF3905_MIPI_write_cmos_sensor(0xee,0x30);
	BF3905_MIPI_write_cmos_sensor(0xb0,0xe0);///////////zj  //0xe0 //00 zj20140114//
	...
	BF3905_MIPI_write_cmos_sensor(0xb2,0xa8);//0xa0//zj 0xa0//0xb0
	BF3905_MIPI_write_cmos_sensor(0x55,0x00);
	...
	BF3905MIPI_HVMirror(IMAGE_NORMAL);//IMAGE_NORMAL//IMAGE_HV_MIRROR
}
