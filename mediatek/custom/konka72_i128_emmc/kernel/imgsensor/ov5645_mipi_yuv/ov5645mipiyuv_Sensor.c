...
void OV5645MIPIInitialSetting(void)
{
...
#ifdef __MIRROR_DEBUG__	
    OV5645MIPISENSORDB("%s()line = %d 0x3618, 0x04\n ",__func__,__LINE__);
...
#ifdef __MIRROR_DEBUG__
	OV5645MIPI_write_cmos_sensor(0x3820, 0x41 | 0x06);//	; flip off, V bin on
	OV5645MIPI_write_cmos_sensor(0x3821, 0x07 & 0x01);//	; mirror on, H bin on
#else
	OV5645MIPI_write_cmos_sensor(0x3820, 0x41);//0x47	; flip off, V bin on
	...
	OV5645MIPI_write_cmos_sensor(0x5186, 0x1c);//
	OV5645MIPI_write_cmos_sensor(0x5187, 0x1a);//
	OV5645MIPI_write_cmos_sensor(0x5188, 0x10);//
	OV5645MIPI_write_cmos_sensor(0x5189, 0x80);//
	OV5645MIPI_write_cmos_sensor(0x518a, 0x59);//
	OV5645MIPI_write_cmos_sensor(0x518b, 0xd0);//
	OV5645MIPI_write_cmos_sensor(0x518c, 0x90);//
	OV5645MIPI_write_cmos_sensor(0x518d, 0x3a);//
	OV5645MIPI_write_cmos_sensor(0x518e, 0x29);//
	OV5645MIPI_write_cmos_sensor(0x518f, 0x56);//
	OV5645MIPI_write_cmos_sensor(0x5190, 0x41);//
	...
	OV5645MIPI_write_cmos_sensor(0x5384, 0x4);//3
	OV5645MIPI_write_cmos_sensor(0x5385, 0x7e);//69
	OV5645MIPI_write_cmos_sensor(0x5386, 0x82);//
	OV5645MIPI_write_cmos_sensor(0x5387, 0x8f);//
	OV5645MIPI_write_cmos_sensor(0x5388, 0x83);//
	...
	OV5645MIPI_write_cmos_sensor(0x5800, 0x2b);//lsc
	...
	OV5645MIPI_write_cmos_sensor(0x5805, 0x32);//
	OV5645MIPI_write_cmos_sensor(0x5806, 0xd );//
	OV5645MIPI_write_cmos_sensor(0x5807, 0x9 );//
	OV5645MIPI_write_cmos_sensor(0x5808, 0x5 );//
	OV5645MIPI_write_cmos_sensor(0x5809, 0x6 );//
	OV5645MIPI_write_cmos_sensor(0x580a, 0x9 );//
	...
	OV5645MIPI_write_cmos_sensor(0x5811, 0xb );//
	OV5645MIPI_write_cmos_sensor(0x5812, 0x9 );//
	...
	OV5645MIPI_write_cmos_sensor(0x5817, 0xc );//
	OV5645MIPI_write_cmos_sensor(0x5818, 0xe );//
	OV5645MIPI_write_cmos_sensor(0x5819, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x581a, 0x6 );//
	OV5645MIPI_write_cmos_sensor(0x581b, 0x7 );//
	OV5645MIPI_write_cmos_sensor(0x581c, 0xa );//
	OV5645MIPI_write_cmos_sensor(0x581d, 0xf );//
	OV5645MIPI_write_cmos_sensor(0x581e, 0x2d);//
	OV5645MIPI_write_cmos_sensor(0x581f, 0x16);//
	OV5645MIPI_write_cmos_sensor(0x5820, 0x13);//
	OV5645MIPI_write_cmos_sensor(0x5821, 0x13);//
	OV5645MIPI_write_cmos_sensor(0x5822, 0x16);//
	OV5645MIPI_write_cmos_sensor(0x5823, 0x36);//
	OV5645MIPI_write_cmos_sensor(0x5824, 0x46);//
	OV5645MIPI_write_cmos_sensor(0x5825, 0x28);//
	OV5645MIPI_write_cmos_sensor(0x5826, 0x2a);//
	OV5645MIPI_write_cmos_sensor(0x5827, 0x2a);//
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);//18	; sharpen MT 
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1  
	OV5645MIPI_write_cmos_sensor(0x5307, 0x3f);//	; DNS off2 

	OV5645MIPI_write_cmos_sensor(0x5302, 0x15);
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x06);
	OV5645MIPI_write_cmos_sensor(0x5307, 0x20);
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
...
#else	
    OV5645MIPI_write_cmos_sensor(0x3820, 0x40);//0x46	; flip off, V bin off
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);//	; sharpen MT 
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1  
	OV5645MIPI_write_cmos_sensor(0x5307, 0x3f);//10	; DNS off2 

	OV5645MIPI_write_cmos_sensor(0x5302, 0x1c);
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x06);
...
#ifdef __MIRROR_DEBUG__
    OV5645MIPI_write_cmos_sensor(0x3820, 0x46);//   0x40; flip off, V bin off
    OV5645MIPI_write_cmos_sensor(0x3821, 0x00);//   0x06; mirror on, H bin off
    
    OV5645MIPI_write_cmos_sensor(0x4514, 0x88);  //0x00
#else	
...
void OV5645MIPI_set_saturation(UINT16 para)
{
    switch (para)
    {
        case ISP_SAT_HIGH:
			OV5645MIPI_write_cmos_sensor(0x3212,0x03);
			OV5645MIPI_write_cmos_sensor(0x5381,0x21);
        ...
        case ISP_SAT_MIDDLE:
			...
			OV5645MIPI_write_cmos_sensor(0x5384,0x4 );//3
			OV5645MIPI_write_cmos_sensor(0x5385,0x7e);//69
			OV5645MIPI_write_cmos_sensor(0x5386,0x82);//6c
			OV5645MIPI_write_cmos_sensor(0x5387,0x8f);//77
			OV5645MIPI_write_cmos_sensor(0x5388,0x83);//6d
			OV5645MIPI_write_cmos_sensor(0x5389,0x0c);//a    
			OV5645MIPI_write_cmos_sensor(0x538a,0x01);
			OV5645MIPI_write_cmos_sensor(0x538b,0x98);	
			OV5645MIPI_write_cmos_sensor(0x3212,0x13);
			OV5645MIPI_write_cmos_sensor(0x3212,0xa3);
