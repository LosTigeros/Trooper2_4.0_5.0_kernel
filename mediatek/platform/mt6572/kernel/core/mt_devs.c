...
#if defined(__M8522__) || defined(__M8525__)

//Chenzz 2013-10-12 10:44:14 防止上报的配置 存在ALS
//已经将宏修改为 CUSTOM_CTP_VIRTUAL_PS, 并且修改方便挪至 projectconfig.mk定义.
//#define CUSTOM_KERNEL_ALSPS
...
//for __M8526__ NMI_TV
#if defined (NMI_TV_SUPPORT)
static struct platform_device nmi_device = 
{
	.name = "nmiatv",
	.id = -1
};
...
//Chenzz Mod 2013-10-12 11:04:42
//#if defined(CUSTOM_KERNEL_ALSPS)
#if defined(CUSTOM_KERNEL_ALSPS) || defined(CUSTOM_CTP_VIRTUAL_PS)
...
#if defined (NMI_TV_SUPPORT)
	retval = platform_device_register(&nmi_device);
